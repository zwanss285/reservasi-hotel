...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Edit Tipe Kamar</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.type-kamar.update', $typeKamar->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_type') is-invalid @enderror" 
                       id="nama_type" name="nama_type" value="{{ old('nama_type', $typeKamar->nama_type) }}" required>
                @error('nama_type')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                          id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $typeKamar->deskripsi) }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('fasilitas') is-invalid @enderror" 
                          id="fasilitas" name="fasilitas" rows="3" required>{{ old('fasilitas', $typeKamar->fasilitas) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('harga_per_malam') is-invalid @enderror" 
                               id="harga_per_malam" name="harga_per_malam" value="{{ old('harga_per_malam', $typeKamar->harga_per_malam) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('kapasitas_maksimal') is-invalid @enderror" 
                               id="kapasitas_maksimal" name="kapasitas_maksimal" value="{{ old('kapasitas_maksimal', $typeKamar->kapasitas_maksimal) }}" required>
